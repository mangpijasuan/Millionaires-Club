...
function setupHeaders() {
  ...
  const loansHeaders = ['id', 'borrowerId', 'cosignerId', 'originalAmount', 'remainingBalance', 'termMonths', 'status', 'startDate', 'nextPaymentDue', 'issuedBy', 'borrowerSignature', 'signedDate'];
